...
google_start = "google-chrome-stable"
editor = os.getenv("EDITOR") or "nano"
editor_cmd = terminal .. " -e " .. editor
rubymine = "/home/rootooz/programms/RubyMine-2016.1.2/bin/rubymine.sh"
thunar = 'thunar'
geany = 'geany'
firefox = 'firefox'
opera = 'opera'
...
for s = 1, screen.count() do
    ...
    tags[s] = awful.tag({ 'Web', 'IDEA', 'Work', 'IM', 'Other' }, s, layouts[1])
end
-- }}}
...
web_menu = {
	{ 'Google Chrome', google_start }, {'Firefox', firefox}, {'Opera', opera}
}
